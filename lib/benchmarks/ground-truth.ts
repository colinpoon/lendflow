...
export const GROUND_TRUTH: GroundTruthEntry[] = [
  {
    ...
    source_notes: "Placeholder values - requires manual verification from PDF",
  },
  {
    document: "Zedcor-FY2024",
    filename: "2024-12-31-Q4-Zedcor-Inc.-Financial-Stmts-4.9.2025v1.pdf",
    fiscal_year: "2024",
    values: {
      // TODO: Manually verify from source PDF before benchmarking
      revenue: 0, // Placeholder - read from income statement
  ...
  },
  {
    ...
    filename: "Taiga_-_December_31,_2024_audited_financial_statements.pdf",
    fiscal_year: "2024",
    values: {
      // TODO: Manually verify from source PDF before benchmarking
      revenue: 0, // Placeholder - read from income statement
    ...
    (entry) =>
      ...
      (entry.filename.toLowerCase().includes(normalizedInput) ||
        ...
        normalizedInput.includes(
          entry.document.toLowerCase().replace("-", "")
        ))
  );
}
 ...
 */
export function isGroundTruthPopulated(entry: GroundTruthEntry): boolean {
