...
const AdjustedEBITDAPanel: React.FC<AdjustedEBITDAPanelProps> = ({ financialData }) => {
  if (
  ...
  const years = Object.keys(financialData.metrics_by_year).sort().reverse();
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Adjusted EBITDA</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-lg p-4 text-center border border-black">
            <p className="text-sm text-gray-600 font-medium">Reported EBITDA</p>
        ...
        {/* Formula */}
        <div className="rounded-lg p-3 text-center border border-black">
            ...
            <AccordionItem value="breakdown" className="border rounded-lg px-4">
              ...
              <AccordionContent>
                ...
                <AdjustmentCategory
                  ...
                  items={[
                    { label: 'Stock-Based Compensation', value: components.stock_based_compensation },
                    { label: 'Impairment Charges', value: components.impairment_charges },
                    { label: 'Goodwill Impairment', value: components.goodwill_impairment },
                    { label: 'Unrealized Gains/Losses', value: components.unrealized_gains_losses },
                    { label: 'Deferred Compensation', value: components.deferred_compensation },
                    { label: 'Loss on Disposal of Assets', value: components.loss_on_disposal },
                ...
                <AdjustmentCategory
                  ...
                  items={[
                    { label: 'Restructuring Costs', value: components.restructuring_costs },
                    { label: 'Severance Costs', value: components.severance_costs },
                    { label: 'Transaction Costs', value: components.transaction_costs },
                    { label: 'Legal Settlements', value: components.legal_settlements },
                    { label: 'Professional Fees (One-Time)', value: components.professional_fees_one_time },
                    { label: 'Casualty Losses', value: components.casualty_losses },
                    { label: 'Other One-Time Expenses', value: components.other_one_time_expenses },
                  ]}
                />
                ...
                <AdjustmentCategory
                  ...
                  isSubtraction
                  items={[
                    { label: 'Gain on Disposal of Assets', value: components.gain_on_disposal },
                    { label: 'Gain on Asset Sale', value: components.gain_on_asset_sale },
                    { label: 'Other Income (Non-Operating)', value: components.other_income_non_operating },
                    { label: 'Insurance Proceeds', value: components.insurance_proceeds },
                    { label: 'Other One-Time Gains', value: components.other_one_time_gains },
                  ]}
                />
                ...
                <AdjustmentCategory
                  ...
                  items={[
                    { label: 'Owner Compensation Adjustment', value: components.owner_compensation_adjustment },
                    { label: 'Related Party Adjustments', value: components.related_party_adjustments },
                    { label: 'Management Fees Adjustment', value: components.management_fees_adjustment },
                  ]}
                />
                ...
                {breakdown.accounting_adjustments !== 0 && (
                  <AdjustmentCategory
                    ...
                    items={[
                      { label: 'Accounting Policy Changes', value: components.accounting_policy_adjustments },
                    ]}
                  />
                )}
                ...
                <AdjustmentCategory
                  ...
                  items={[
                    { label: 'Cost Savings', value: components.pro_forma_cost_savings },
                      ...
                      <tr className="border-b">
                        ...
                        {years.map((yr) => (
                          <td key={yr} className="text-right py-2 px-2">
                            {formatCurrency(financialData.metrics_by_year[yr].ebitda)}
                          </td>
                        ))}
                      </tr>
                      <tr className="border-b bg-green-50">
                        ...
                        {years.map((yr) => (
                          <td key={yr} className="text-right py-2 px-2 font-medium">
                            {formatCurrency(financialData.metrics_by_year[yr].adjusted_ebitda)}
                          </td>
                        ))}
                      </tr>
                    </tbody>
